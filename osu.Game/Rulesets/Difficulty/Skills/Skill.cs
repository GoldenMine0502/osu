...
namespace osu.Game.Rulesets.Difficulty.Skills
{
    ...
    public abstract class Skill
    {
        ...
        internal void ProcessInternal(Skill[] preSkills, int index, DifficultyHitObject current)
        {
        ...
        protected abstract void Process(Skill[] preSkills, int index, DifficultyHitObject current);
